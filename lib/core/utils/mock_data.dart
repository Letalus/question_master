...
final kQuizList = <QuizModel>[
  ...
  QuizModel(question: AppStrings.flutter_hot_reload.tr(), image: AssetPaths.image.hot, isCorrect: false),
  QuizModel(
      question: AppStrings.flutter_good_community.tr(), image: AssetPaths.image.community, isCorrect: true),
  ...
  QuizModel(
      ...
      isCorrect: true),
  QuizModel(
      question: AppStrings.structure_of_flutter_consist.tr(), image: AssetPaths.image.cplus, isCorrect: true),
  QuizModel(
  ...
  QuizModel(
      ...
      isCorrect: true),
  QuizModel(
      question: AppStrings.it_is_flutter_ready_to.tr(), image: AssetPaths.image.variety, isCorrect: false),
  QuizModel(question: AppStrings.since_flutter_is_new.tr(), image: AssetPaths.image.newImg, isCorrect: true),
  QuizModel(
